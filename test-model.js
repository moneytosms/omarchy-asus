...
assert.deepEqual(M.parseGpuBootState("0 0\n"), { loaded: true, mux: false, dgpuDisabled: false })
assert.deepEqual(M.parseGpuBootState("1 1\n"), { loaded: true, mux: true, dgpuDisabled: true })
assert.deepEqual(M.parseGpuBootState("\n"), { loaded: false, mux: false, dgpuDisabled: false })
